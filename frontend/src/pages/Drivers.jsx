...
export default function Drivers() {
  const { drivers, updateDriverStatus, verifyDriver } = useAdmin();
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-full">
            ...
            <span className="text-sm text-emerald-400">{drivers.filter(d => d.status === 'online').length} متصل</span>
          </div>
        </div>
      </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-400 mt-1">{drivers.filter(d => d.verified).length}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-amber-400 mt-1">{drivers.filter(d => !d.verified).length}</p>
              </div>
