          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">{t('مرحباً', 'Welcome')}, {user?.name}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {unreadMessagesCount > 0 && (
                  <Badge className="absolute -top-2 -right-2 bg-red-500 hover:bg-red-500 h-5 w-5 p-0 flex items-center justify-center text-xs">
                    {unreadMessagesCount}
                  </Badge>
                )}
                <span className="hidden sm:inline">{t('الدردشة', 'Chat')}</span>
              </Button>
              <Button
                variant="outline"
              ...
              >
                ...
                <span className="hidden sm:inline">{t('التوصيل', 'Delivery')}</span>
              </Button>
              <CountrySelector />
