...
export default function Restaurants() {
  const { restaurants, updateRestaurantStatus } = useAdmin();
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-400 mt-1">{restaurants.filter(r => r.status === 'open').length}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-amber-400 mt-1">{restaurants.reduce((acc, r) => acc + r.orders, 0).toLocaleString()}</p>
              </div>
